    ...
    <div class="main">
        <div ref="page" class="page" :style="{backgroundColor:this.page.bg_image}">
            <div class="info">
                ...
                <div v-if="showCode == 0" class="content" >
                    <canvas ref="barcode"></canvas>
                </div>
                <div v-else class="content">
                    <img :src="qrCodeImg" alt="">
                    <p style="margin-top:-2%;color: orange;font-size: 14pt;text-align:center;font-weight: bolder;">长按识别二维码领取</p>
                </div>
        ...
        <alertSystem :type="alertType" :content="alertInfo" v-show="hasShowSystemAlert" @rulesStatus="rulesStatus"></alertSystem>
    </div>
</template>
