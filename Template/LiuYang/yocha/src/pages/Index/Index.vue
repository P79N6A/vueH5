<template>
    ...
    <swiper class="main" v-else :options="swiperOption" ref="mySwiper">
        <swiper-slide class="page swiper-no-swiping" :style="{backgroundImage:'url('+ this.page1.bg_image +')'}">
            ...
            <div class="mains" :style="{backgroundImage:'url('+ this.page1.supernatant +')'}">
                <img src="static/img/logo.png" alt="" class="title">
                <img src="static/img/rlogo.png" alt="" class="left">
                <img src="static/img/yl.png" alt="" class="center">
                <img src="static/img/llogo.png" alt="" class="right">
                <img src="static/img/anniu.png" alt="" class="button1">
            </div>
        </swiper-slide>
