...
const getcouponlist = (openid, activity_id, host) => {
  ...
  return return_type = {
    ...
    "return_couponlist": [{
      ...
      "status": "OVERDUE", //卡券状态 1、"OVERDUE"(已过期) 2、"APPLIED" (已领取)3、"CONSUMED"(已使用)
      ...
      "begin_date": "2017-06-01 00:00", //有效期：开始日期
      "end_date": "2017-09-30 23:59", //有效期：结束日期
      "status": "APPLIED", //卡券状态 1、"OVERDUE"(已过期) 2、"APPLIED" (已领取)3、"CONSUMED"(已使用)
      "go_url": "http://baidu.com" //跳转地址
    }, {
      "logo_img_src": "./static/data/images/prize01.png", //logo图片的地址
      "title": "可乐.可乐.可乐.可乐.可乐.可口可乐", //标题
      "sub_title": "买二赠一,买一赠一,买一赠一,买一赠一", //副标题
      "begin_date": "2017-06-01 00:00", //有效期：开始日期
      "end_date": "2017-09-30 23:59", //有效期：结束日期
      "status": "CONSUMED", //卡券状态 1、"OVERDUE"(已过期) 2、"APPLIED" (已领取)3、"CONSUMED"(已使用)
      "go_url": "http://baidu.com" //跳转地址
    }, {
      "logo_img_src": "./static/data/images/first-prize.png", //logo图片的地址
      "title": "可乐.可乐.可乐.可乐.可乐.可口可乐", //标题
