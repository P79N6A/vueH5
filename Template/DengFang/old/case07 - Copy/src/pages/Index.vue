  ...
  <section id="template">
    ...
    <div class="panorama">
      <div class="panorama-parent" @touchstart="startMove" @touchmove="movePanorama"
           @touchend="endMove">
        <div class="panorama-image" :style='{backgroundImage:"url("+panoramaImage.src+")"}'></div>
  ...
  export default {
    ...
    methods: {
      ...
      createdImg(){
        ...
        setTimeout(function () {
          $('.panorama-parent').css({
            '-webkit-transform': 'translate3d(' + maxLeft + 'px,0,0)',
            'transform': 'translate3d(' + maxLeft + 'px,0,0)',
