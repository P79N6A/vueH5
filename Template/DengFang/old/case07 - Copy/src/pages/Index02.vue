  ...
  export default {
    ...
    methods: {
      ...
      createdImg(){
        ...
        //
        const selac = this.images.bg_image_width / 2 / winW;
        const oneView = this.images.bg_image_width / 10 / this.fontSize;
        console.log(oneView)
        $('.view .slice').css({
          'width': oneView + 'rem',
          /*  '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',
           'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',*/
        });
        $('.view .s2').css({
          'background-position': -1 * oneView + 'rem 0',
          /*      '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',
           'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',*/
        });

        $('.view .s3').css({
          'background-position': -2 * oneView + 'rem 0',
          /*  '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -40deg)',
           'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -40deg)',*/
        });
        $('.view .s4').css({
          'background-position': -3 * oneView + 'rem 0',
          /*          '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -40deg)',
           'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -40deg)',*/
        });
        $('.view .s5').css({
          'background-position': -4 * oneView + 'rem 0',
          /*    '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',
           'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, -20deg)',*/
        });
        ...
        Modernizr.load({
          ...
          callback: function (url, result, key) {
            ...
            setTimeout(function () {
              ...
              $('.view .s2').css({
                '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, 0deg)',
                'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, 0deg)',
              })
              $('.view .s3').css({
                '-webkit-transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, 0deg)',
                'transform': 'translate3d(' + oneView + 'rem, 0, 0) rotate3d(0, 1, 0, 0deg)',
...
<style scoped lang='less'>
  @import "../assets/3d-css/style_common.css";
  @import "../assets/3d-css/style3.css";
  @import 'index';
</style>
