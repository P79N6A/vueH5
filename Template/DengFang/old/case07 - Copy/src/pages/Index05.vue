    ...
    <div class="panorama">
      <div class="panorama-parent" @touchstart="startMove" @touchmove="movePanorama"
        ...
        <div class="panorama-image">
          <div id="main"></div>
          <div class="panorama-image-box">
            <img class="panorama-image-one" v-for="item in images.bg_image_box" :key="item" :src="item">
            <!-- <div class="panorama-image-one" v-for="item in images.bg_image_box" :key="item"
...
//              self.setImg();
      ...
      createdImg(){
        ...
        this.pano.position(0, 0, -1000).updateT();
        ...
        function go() {
          ...
          i++;
          if (i <= 240) {
            self.pano.rotate(0, 1.5, 0).updateT();
      ...
      movePanorama(e){
        ...
        if (!this.hasDefaultMove) {
          ...
          let translateNumber = t.pageX - this.pageX;
