...
const getcoupon = (item_id, openid, activity_id, xjj_openId, third_party_name, host) => {
  let return_type = {};
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.return_code !== 200) {
          if (data.return_code == "10220002" || data.return_msg == "谢谢参与") {
            return_type.return_code = "200";
            return_type.return_msg = "";
            return_type.item_id = -1;
          } else {
  ...
  return return_type = {
    ...
    logo: "./static/data/images/second-prize.png",//弹出中奖的logo地址
