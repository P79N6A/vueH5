        ...
        if (typeof(third_party_openid) == "undefined") {
            ...
            var img_box = [
                ...
                { "img_name": "游戏礼包", "img_src": "play" },
                { "img_name": "30元代金券", "img_src": "j30" },
                { "img_name": "兄弟套餐优惠券", "img_src": "jbrother" },
                { "img_name": "权金城买一赠一券", "img_src": "jbuyone" },
                { "img_name": "姐妹套餐优惠券", "img_src": "jsister" },
                { "img_name": "全场7折折扣券", "img_src": "q7" },
                { "img_name": "传统石锅拌饭买一赠一券", "img_src": "qbuyone" }
            ];
            // 请求分享
            $.ajax({
                type: "GET",
            ...
            $(".btn_").click(function(event) {
                ...
                if(localStorage[str] == 3){
                   getData.activity_item_id = "lottery-2565";
                }
