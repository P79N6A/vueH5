...
// my_alert("select", "加载成功","卡券信息加载成功啦，","请再试试吧！",["知道啦","下一步"],["green","red"],function(){alert("左")},function(){alert("右")})
