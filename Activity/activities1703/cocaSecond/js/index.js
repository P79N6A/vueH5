...
var now_img;
var img_box = [
    { "img_name": "500ml樱桃可乐买一赠一", "img_src": "buy" },
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.return_code != 200) {
                ...
                if (img_name == "500ml樱桃可乐买一赠一" || img_name == "500ml樱桃可乐免费领") {
...
$(".get_coupon").click(function(event) {
    if (img_name == "500ml樱桃可乐买一赠一" || img_name == "500ml樱桃可乐免费领") {
        window.location.href = coupon_bag_host + 'webcouponshow_normal_qr.html' + "?coupon_code=" + coupon_code + "&openid=" + openid;
