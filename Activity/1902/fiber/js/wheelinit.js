...
$.getJSON("config.json", function (result){
        ...
        $('.start_circle').css('left', ruler * 11 - 10 + 'px')
        $('.start_circle').css('width', ruler * 80 + 15 + 'px')
        $('.start_circle').css('height', ruler * 80 + 15 + 'px')
        $('.start_circle .item').css('left', ruler * 5 - 5 + 'px')
        $('.start_circle .item').css('top', ruler * 5 -5 + 'px')
        $('.start_circle .item').css('width', ruler * 70 + 25 + 'px')
        $('.start_circle .item').css('height', ruler * 70 + 25 + 'px')
