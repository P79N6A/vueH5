...
if (typeof(third_party_openid) == "undefined") {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.return_code != 200) {
                    ...
                    if (img_name == "美汁源淳萃饮料买一赠一" || img_name.indexOf("买一赠一") > -1) {
                        $(".coupon_img").attr("src", "img/buy.png");
                    } else if (img_name == "美汁源淳萃饮料免费领" || img_name.indexOf("免费") > -1) {
                        $(".coupon_img").attr("src", "img/free.png");
                    } else if (img_name == "小乐西瓜优惠券" || img_name.indexOf("西瓜") > -1) {
                        $(".coupon_img").attr("src", "img/zd_fl.png");
                    } else if (img_name == "泰国香水椰青优惠券" || img_name.indexOf("泰国香水椰") > -1) {
                        $(".coupon_img").attr("src", "img/zd_mj.png");
    ...
    $(".get_coupon").click(function(event) {
        if (img_name == "美汁源淳萃饮料买一赠一" || img_name.indexOf("美汁源") > -1 || img_name == "美汁源淳萃饮料免费领") {
