...
$(document).ready(function() {
    //动态添加大转盘的奖品与奖品区域背景颜色
    turnplate.restaraunts = ["瑜伽运动||套装", "雪碧纤维+500ml||饮料一瓶", "谢谢惠顾", "瑜伽垫", "雪碧纤维+500ml||饮料一瓶", "谢谢惠顾"];
    turnplate.colors = ["#93d50a", "#f8d000", "#93d50a", "#f8d000", "#93d50a", "#f8d000"];
                ...
                if (data.return_code != 200) {
                    if (data.return_msg == "超出每人每天参与次数，欢迎明天继续参与") {
                        ...
                        if(data.return_msg == '谢谢参与'){
                            $(".alert_gift_box").css({ "background-image": "url(images/alert_sorry.png)", "top": "5%" })
                            item = 6
...
//转盘宽高相等
$(function(){
    $('.banner .turnplate').css('height', $('.banner .turnplate').css('width'));
});