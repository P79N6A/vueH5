	...
	$('#menu-4').click(function() {
		swal({  
			html: '<a class="notice" href="notice_template.html" >温馨提示</a><a class="notice" href="notice_template2.html" >停梯通知</a><a class="notice" href="notice_template3.html" >停水通知</a>',
	...
	var showLocation = function (city, detail) {
		var point = null,
