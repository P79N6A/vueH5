...
$(document).ready(function() {
    //动态添加大转盘的奖品与奖品区域背景颜色
    turnplate.restaraunts = ["330ml零度||可口可乐||1罐", "精美礼品||1份", "淘票票||优惠券1张", "330ml零度||可口可乐||1罐", "精美礼品||1份", "谢谢参与"];
    turnplate.colors = ["#d00000", "#ff9f00", "#d00000", "#ff9f00", "#d00000", "#ff9f00"];
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.return_code != 200) {
                    ...
                    if (GetSelect.indexOf("可口可乐1罐") > 0) {
                        $(".alert_gift_box").css({ "background-image": "url(images/alert_kele.png)", "top": "35%" });
                        item = 1;
                    } else if (GetSelect.indexOf("可乐精美礼品一份") > 0) {
                        $(".alert_gift_box").css({ "background-image": "url(images/alert_gift.png)", "top": "35%" })
                        item = 2
                    } else if (GetSelect.indexOf("电影优惠券一张") > 0) {
