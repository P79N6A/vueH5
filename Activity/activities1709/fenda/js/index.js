        ...
        success: function(data) {
            ...
            if (data.return_code != 200) {
                ...
                if (img_name == "600ml芬达汽水买一赠一" || img_name.indexOf("买一赠一") > -1) {
                    ...
                    $(".alert_gift_box").css('background-image', "url(img/Popup.png)");
                } else if (img_name == "600ml芬达汽水免费领" || img_name.indexOf("免费领") > -1) {
                    $(".coupon_img").attr("src", "img/fd.png");
                    $(".coupon_title").html("免费赠饮券");
                    $(".coupon_desc").html("芬达汽水1瓶").css("text-indent", "0rem");
                    $(".alert_gift_box").css('background-image', "url(img/Popup.png)");
                } else if (img_name == "七幕人生话剧95折优惠" || img_name.indexOf("七幕人生") > -1) {
                    $(".coupon_img").attr("src", "img/qm.png");
                    $(".coupon_title").html("七幕人生话剧95折优惠");
                    $(".coupon_desc").html("七幕人生话剧95折优惠").css("text-indent", "0rem");
                } else if (img_name == "宫保鸡丁第二份半价" || img_name.indexOf("宫保鸡丁") > -1) {
                    $(".coupon_img").attr("src", "img/hehegu.png");
                    $(".coupon_title").html("宫保鸡丁第二份半价");
                    $(".coupon_desc").html("宫保鸡丁第二份半价").css("text-indent", "0rem");
                } else if (img_name == "权金城免费烤五花肉" || img_name.indexOf("五花肉") > -1) {
                    $(".coupon_img").attr("src", "img/quanjincheng.png");
                    $(".coupon_title").html("权金城免费烤五花肉");
                    $(".coupon_desc").html("权金城免费烤五花肉").css("text-indent", "0rem");
                } else if (img_name == "权味10元代金券" || img_name.indexOf("10元") > -1) {
                    $(".coupon_img").attr("src", "img/quanwei.png");
                    $(".coupon_title").html("权味10元代金券");
                    $(".coupon_desc").html("权味10元代金券").css("text-indent", "0rem");
                }
                $(".show_box").show();
            }
        },
...
$(".get_coupon").click(function(event) {
    if (img_name == "600ml芬达汽水买一赠一" || img_name == "600ml芬达汽水免费领") {
