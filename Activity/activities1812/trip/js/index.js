        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.return_code != 200) {
                    ...
                    else if(coupon_id == 2046){
                        var prize_pic = 'images/x6.png';
                    }
                    else if(coupon_id == 2045){
                        var prize_pic = 'images/x8.png';
                    }
                    else{
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(var i in data.data.list){
                count ++;
                if(data.data.list[i].id == 2047){
                    var pic = 'images/1.png';
                }else if(data.data.list[i].id == 2046){
                    var pic = 'images/6.png';
                }else if(data.data.list[i].id == 2045){
                    var pic = 'images/8.png';
                }else{
                    count --;
                    continue;
                }
