...
$(document).ready(function() {
    //动态添加大转盘的奖品与奖品区域背景颜色
    turnplate.restaraunts = ["汉拿山烤肉20元||代金券1张", "世界杯球衣", "纪念版足球", "汉拿山烤肉20元||代金券1张", "世界杯球衣", "纪念版足球"];
...
$(".alert_gift_box").click(function(event) {
    if(item == 1){
        window.location.href = "http://short.aikaka.com.cn/v1.0/location/redirect?url=emzvDmenTS";
    }else{
